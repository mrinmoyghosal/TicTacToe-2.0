...
public interface PlayerInterface {
	...
	/**
	 * Accepts an instance of {@link PlayField} and calculates next move based on
	 * board status. If this is not an automatic player, this method will return an
	 * {@code Optional.empty()}
	 * 
	 * @param board copy of board
	 * @return the next move of the AI player or {@code Optional.empty()} for non-ai
	 *         players.
	 */
